				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<table class="table table-bordered">
										...
										?>
										<tr>
											<td><select required class=" max-select form-control input-sm" name="product[]">
												<?php 
												$prods = $this->stock->getStocksToRecieved();
											...
											<td><input class="form-control input-sm" placeholder="Quantity" value="<?php echo $product['qty'] ?>" name="qty[]"/></td>
