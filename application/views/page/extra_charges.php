		...
		<div class="panel panel-default">
                ...
                <div class="tab-container">
                  <ul class="nav nav-tabs">
					...
					<li class="active"><a href="<?php  echo base_url('dashboard/extra_charges') ?>">Store Settings</a></li>
                  </ul>
				  <div class="tab-content">
					...
					<div class="row">
						...
						<form action=""  method="post" enctype="multipart/form-data">
							...
							<div class="form-group xs-pt-10">
							<br/><br/><br/>
							  <label for="branch_address" class="col-sm-12 control-label">No of Expiry Day to count</label>
							  <div class="col-sm-12">
								<input id="expire_count" value="<?php echo $extra_charges['expire_count'] ?>" type="number" name="expire_count" placeholder="" class="form-control input-sm">
							  </div>
							</div>
							<div class="form-group xs-pt-10">
							<br/><br/><br/>
