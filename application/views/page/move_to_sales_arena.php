<div class="row">
	<div class="col-sm-12">
		...
		<div class="panel">
			 <div class="panel-heading">Move Stock to Sales Arena
			  ...
			  <div class="panel-body">
					...
					<div class="form-group xs-mt-10">
                      ...
                      <div class="col-sm-10">
                        <input id="move_qty" required value="" max="<?php  echo $stock['quantity'] ?>" type="number" name="qty_to_move"  placeholder="Enter Quantity to moved to Arena" class="form-control input-sm">
                      </div>
                    </div>
					<div class="form-group xs-mt-10">
