...
<div class="col-sm-12">
			<form action="" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">Receive Stock
					<div class="tools">
						 <button class="btn btn-sm btn-primary"><i class="mdi mdi-plus"></i> Save Received</button>
					</div>
					</div>
					 ...
					 <div class="row">
							<div class="col-lg-3">
								<div class="form-group xs-pt-10">
								  ...
								  <input id="transfer_date" required type="text" value="<?php echo date('Y-m-d'); ?>" name="recieved_date" data-min-view="2" data-date-format="yyyy-mm-dd"  placeholder="Date Available" class="date form-control input-sm">
								</div>
							</div>
							...
							<div class="col-lg-3">
								<div class="form-group xs-pt-10">
								  ...
								  <input type="text" placeholder="Transfer User Full name" name="transfer_user" class="form-control input-sm">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="form-group xs-pt-10">
								  <label>Received User</label>
								   <input type="text" name="reciever_userfullname" readonly required value="<?php  echo $this->tank_auth->get_username(); ?>" placeholder="Transfer User" class="form-control input-sm">
								 </div>
							</div>
						</div>
						<div class="row">
