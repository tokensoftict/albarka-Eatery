...
<div class="col-sm-12">
	 ...
	 <div class="panel panel-default panel-table">
                <div class="panel-heading">Order Report List(s)
                 <div class="tools">
		...
		?>
				...
				<tbody>
					...
					$status = array(
						...
						$ins = $this->stock->getOrdersRange($from,$to);
						$alltotal =0;
						$alldiscount =0;
						foreach($ins as $in){
                            ...
                            <td><?php echo $status[$in['status']] ?></td>
								<td>
											...
											<div class="dropdown">
												  ...
												  <li><a href="<?php  echo base_url('dashboard/view_orders/'.$in['reciept_id']) ?>">View</a></li>
