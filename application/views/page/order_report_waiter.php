<div class="row">
	<div class="col-sm-12">
		...
		<div class="panel panel-default">
                <div class="panel-heading">Order Report By Server</div>
                ...
                <div class="panel-heading">Sales Report By Server
                 <div class="tools">
					<form method="post" class="form-horizontal" id="change_branch" action="">
						...
						?>
							...
							<label>Select Date</label>
								<input value="<?php echo $_POST['from']  ?>" required type="text" style="padding-left:10px;"  name="from" id="datetimepicker" placeholder="From" class="form-control input-sm datetimepicker" name="from required"/>							
							</div>
							<div class="col-md-4">
								<label>Server</label>
								<select name="customer_id" required class="form-control select2_demo_2 input-sm" id="customer_id">
						...
						<div class="col-md-6">
							<label>Select Date</label>
								<input required value="<?php echo date('Y').'-'.date('m').'-'.date('d')  ?>" data-min-view="2" data-date-format="yyyy-mm-dd" type="text" style="padding-left:10px;"  name="from" id="datetimepicker" placeholder="From" class="form-control input-sm datetimepicker" name="from required"/>							
							</div>
							<div class="col-md-4">
								<label>Waiter</label>
								<select name="customer_id" required class="form-control select2_demo_2 input-sm" id="customer_id">
				...
				<tbody>
					...
					$status = array(
						...
						$ins = $this->stock->getOrdersRange($from,$from,array('waiter_id'=>$customer_id));
						$alltotal =0;
						$alldiscount =0;
						foreach($ins as $in){
