<div class="row">
	<div class="col-sm-12">
		...
		<div class="panel panel-default">
                <div class="panel-heading">Order Report By Sales Rep</div>
                ...
                <div class="panel-heading">Order Report By Sales Rep
                 <div class="tools">
					<form method="post" class="form-horizontal" id="change_branch" action="">
						...
						?>
							...
							<div class="col-md-4">
								...
								<?php
									$stocks = $this->db->get("users")->result_array();
				...
				<tbody>
					...
					$status = array(
						...
						$ins = $this->stock->getOrdersRange($from,$to,array('user_id'=>$customer_id));
						$alltotal =0;
						$alldiscount =0;
						foreach($ins as $in){
