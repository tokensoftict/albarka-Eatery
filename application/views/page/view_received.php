...
<div class="col-sm-12">
				...
				<div class="panel panel-default">
							...
							<div class="col-lg-3">
								<div class="form-group xs-pt-10">
								  <label>Received From</label>
								   <span class="form-control input-sm"><?php echo $transfer['branch']?> </span>
								 </div>
							</div>
							<div class="col-lg-3">
								<div class="form-group xs-pt-10">
					...
					<div class="panel-footer">
							 ...
							 <a href="<?php echo base_url('dashboard/edit_transfer/'.$this->uri->segment(3))  ?>" class="btn btn-sm btn-primary"><i class="mdi mdi-edit"></i>  Edit Received</a>
