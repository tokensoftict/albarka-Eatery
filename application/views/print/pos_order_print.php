...
#invoice-POS #legalcopy {
  ...
  <div id="invoice-POS" align="center">
     <div class="logo" style="margin-bottom:10px;"><center><img style="width:48mm;" src="<?php echo $this->settings->getSettings()['slogo'] ?>" alt="" width="60" /></center></div>
      ...
      <div align="center">
          <span style="font-size:12px;;margin-bottom:6px;">Order ID : <?php echo $payment['reciept_id']  ?></span> <br/>
	  ...
	  <div class="info" align="center">
        <span style="font-weight:bolder;font-size:15px;margin-bottom:10px; margin-top: -15px; display:block;">Order Receipt.</span>
    </div>
	<h6 style="font-family:MyWebFont; font-size:14px;"align="center">Item(s) Ordered</h6>
