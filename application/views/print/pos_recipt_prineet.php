...
#invoice-POS #legalcopy {
  ...
  <div id="invoice-POS">
	...
	<p align="left">
		...
		?>
		<br/>
		Waiter : <?php echo $this->db->get_where("waiter_name",array("SN"=>$payment['waiter_id']))->row()->name  ?>
	  </p>
	  </div>
	  </center>
	  <center id="top">
